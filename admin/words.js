...
systemDictionary = {
	...
	sid: {
		...
		ru: 'получил идентификатор датчика',
		pt: 'recebeu ID do sensor',
		nl: 'ontvangen Sensor ID',
		fr: 'ID de capteur reçu',
		it: 'ricevuto Sensor ID',
		es: 'ID del sensor recibido',
		pl: 'otrzymany identyfikator czujnika'
	},
	stype: {
		en: 'Sensor typ',
		de: 'Sensortyp',
	...
	usid: {
		en: 'unique sensor id',
		de: 'eindeutige Sensor-ID',
		ru: 'уникальный идентификатор датчика',
		pt: 'ID de sensor exclusivo',
		nl: 'uniek sensor-ID',
		fr: 'identifiant de capteur unique',
		it: 'sensore unico',
	...
	'valid sensor types:': {
		...
		de: 'gültige Sensortypen:',
		ru: 'допустимые типы датчиков:',
		pt: 'Tipos de sensores válidos:',
		nl: 'geldige sensortypes:',
		fr: 'types de capteurs valides:',
		it: 'tipi di sensore validi:',
	...
	'Sensor configuration': {
		...
		ru: 'Конфигурация датчика',
		pt: 'Configuração do sensor',
		nl: 'Sensor configuratie',
		fr: 'Configuration du capteur',
		it: 'Configurazione del sensore',
		es: 'Configuración del sensor',
		pl: 'Konfiguracja czujnika'
	},
	'command for stick setup': {
		en: 'command for stick setup',
		de: 'Befehl für Stick-Setup',
		ru: 'команда для настройки палки',
		pt: 'comando para configuração de stick',
		nl: 'commando voor het instellen van de stick',
		fr: 'commande pour la configuration du bâton',
		it: "comando per l'impostazione dello stick",
	...
	'usually empty': {
		...
		pt: 'geralmente vazio',
		nl: 'meestal leeg',
		fr: 'habituellement vide',
		it: 'di solito vuoto',
		es: 'generalmente vacío',
		pl: 'zwykle puste'
	},
